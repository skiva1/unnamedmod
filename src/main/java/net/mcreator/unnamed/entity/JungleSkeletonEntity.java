...
package net.mcreator.unnamed.entity;
...
public class JungleSkeletonEntity extends Monster {
	public JungleSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UnnamedModEntities.JUNGLE_SKELETON.get(), world);
	}

	public JungleSkeletonEntity(EntityType<JungleSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(UnnamedModEntities.JUNGLE_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
