	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition diamond_pickaxe = left_arm.addOrReplaceChild("diamond_pickaxe",
				CubeListBuilder.create().texOffs(88, 10)
						.addBox(1.0F, -6.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(92, 10)
						...
						.addBox(5.0F, 6.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(76, 58)
						.addBox(4.0F, 6.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 40)
				.addBox(-4.0F, -24.0F, -3.0F, 8.0F, 18.0F, 6.0F, new CubeDeformation(-0.01F)),
